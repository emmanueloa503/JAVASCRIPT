...
and tails. However, you can also use numbers as properties. You can even omit the 
quotes for single-word string properties, as follows:
...
typecast them as strings. Make an object that represents a dog called myDog which contains 
